...
║𝙵𝚎𝚊𝚝𝚞𝚛𝚎𝚜  
║┏𝑆𝑡𝑟𝑒𝑎𝑚 𝑉𝑖𝑑𝑒𝑜 & 𝑀𝑢𝑠𝑖𝑐.
║┠𝑃𝑙𝑎𝑦 𝑡𝑒𝑙𝑒𝑔𝑟𝑎𝑚 𝐴𝑢𝑑𝑖𝑜 & 𝑉𝑖𝑑𝑒𝑜 𝐹𝑖𝑙𝑒.
║┗𝐴𝑣𝑜𝑖𝑑 𝑆𝑝𝑎𝑚 & 𝐾𝑒𝑒𝑝 𝐶ℎ𝑎𝑡 𝐶𝑙𝑒𝑎𝑛.
╟𝘾𝙝𝙚𝙘𝙠𝙤𝙪𝙩⌱ @C2_Probot
╚═════༻༺═════╝
"""
...
@ASS_CLI_1.on_message(filters.regex(pattern="kek that doesn't look right. Reply to someone like this:") & filters.group)
